...
Additionally, one of the utilized flutter plugins requires the installation of coding language Rust, which can be easily downloaded + installed from ["https://rustup.rs"].
